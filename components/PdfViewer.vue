<template>
  <div id="pdfvuer">
    <div class="buttons ui grey three item inverted bottom fixed menu transition hidden">
  ...
  methods: {
    ...
    getPdf () {
      ...
      self.pdfdata.then(pdf => {
        ...
        const sticky = document.getElementsByClassName('buttons')[0].offsetTop
        ...
        function changePage () {
          const i = 1, count = Number(pdf.numPages);
          do {
