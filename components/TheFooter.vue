    ...
    <div class="max-w-7xl border-l border-r border-dashed border-gray-700 mx-auto px-4">
      <div class="pt-5 pb-12 md:flex md:items-center md:justify-between">
        <div class="flex space-x-6 md:order-2">
          <a v-if="$store.state.social.facebook" target="_blank" rel="noreferrer"  :href="`https://facebook.com/${$store.state.social.facebook}`" class="text-gray-400 hover:text-gray-300">
          ...
          <a v-if="$store.state.social.instagram" target="_blank" rel="noreferrer"  :href="`https://instagram.com/${$store.state.social.instagram}`" class="text-gray-400 hover:text-gray-300">
          ...
          <a v-if="$store.state.social.twitter" target="_blank" rel="noreferrer"  :href="`https://twitter.com/${$store.state.social.twitter}`" class="text-gray-400 hover:text-gray-300">
          ...
          <a v-if="$store.state.social.github" target="_blank" rel="noreferrer" :href="`https://github.com/${$store.state.social.github}`" class="text-gray-400 hover:text-gray-300">
          ...
          <a v-if="$store.state.social.linkedin" target="_blank" rel="noreferrer" :href="`https://linkedin.com/in/${$store.state.social.linkedin}`" class="text-gray-400 hover:text-gray-300">
          ...
          <a v-if="$store.state.blog.enabled" class="text-gray-300 hover:text-white" href="/feed.xml" target="_blank">
